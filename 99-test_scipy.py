...
axes[0].scatter([a_true], [b_true], color="white", edgecolors="black", s=40, label="true")
axes[0].set_xlabel("a"); axes[0].set_ylabel("b"); axes[0].set_title(f"(a,b) | c={c_hat:.3g}")
...
axes[1].set_xlabel("a"); axes[1].set_ylabel("c"); axes[1].set_title(f"(a,c) | b={b_hat:.3g}")
...
axes[2].set_xlabel("b"); axes[2].set_ylabel("c"); axes[2].set_title(f"(b, c) | a={a_hat:.3g}")
...
surf = ax.plot_surface(AA, BB, Zab, cmap="viridis", linewidth=0, antialiased=True, alpha=0.95)
...
ax.scatter([a_true], [b_true], [z_true_proj], color="white", edgecolors="black", s=45, label="true (c fixed)")
